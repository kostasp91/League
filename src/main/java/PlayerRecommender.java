...
public class PlayerRecommender {
    ...
    public static List<Player> getAllPlayers() throws IOException {
            ...
            for (weeks = 0; weeks < workbook.getNumberOfSheets(); weeks++) {
                ...
                while (rowIterator.hasNext()) {
                    ...
                    try {
                        ...
                        Stats stats = playerStatsMap.getOrDefault(name, new Stats());
                        stats.pos = pos;
                        stats.team = team;
        ...
        for (Map.Entry<String, Stats> entry : playerStatsMap.entrySet()) {
            ...
            //////////  HERE   /////////
            double fantasyPointsProgress;
            if (s.fantasyPointsSecondToLast != 0) {
                fantasyPointsProgress = (s.fantasyPointsLast - s.fantasyPointsSecondToLast) / s.fantasyPointsSecondToLast;
            } else {
                fantasyPointsProgress = 0;
            }

            double minutesProgress;
            if (s.minutesSecondToLast != 0) {
                minutesProgress = (s.minutesLast - s.minutesSecondToLast) / s.minutesSecondToLast;
            } else {
                minutesProgress = 0;
            }
            ////////////////
            ...
            players.add(new Player(name, team, s.pos, avgFantasyPoints, fantasyPointsProgress, avgCost,
